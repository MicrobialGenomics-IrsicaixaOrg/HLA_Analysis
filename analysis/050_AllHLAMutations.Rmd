...
require(dplyr)
require(gdata)
HLA_mutations<-read.xls("data/HLA footprints for AELIX002 analyses without B15 imprints 3-2-2022.xls",sheet = 2)
...
Apparently there are no significant difference between groups regarding the number of HLA-specific mutations, including both ADAPTED and non-ADAPTED.
