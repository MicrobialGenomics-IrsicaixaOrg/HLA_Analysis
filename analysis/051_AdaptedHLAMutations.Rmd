---
title: "Adapted HLA Mutations Only"
author: "Marc Noguera"
date: "3/3/2022"
...
### HLA-specifc mutations within each patient. 2D resolution adapted only.
...
variant_df %>% 
  ...
  dplyr::rename(TreatmentGroup=Treatment.Vax.vs.Pbo,n_adapted_HLA_mutations=total_within_HLA) %>% 
  xlsx::write.xlsx(.,file=paste0(here::here(),"/output/HLAMutations.xls"),sheetName = "AdaptedHLAMutations",append=T)
...
variant_df %>% 
  ...
  ggplot(.,aes(x=ATI_duration,y=n_HLA_mutations,color=ATI_duration))+
    ...
    ggtitle("(gag,pol,nef,vif) HLA-specific mutations vs ATI Duration",subtitle = "Adapted Mutations Only")+
    theme(
      plot.title = element_text(color="black", size=14, face="bold.italic"),
      axis.title.x = element_text(color="darkgrey", size=12, face="bold"),
      axis.title.y = element_text(color="darkgrey", size=12, face="bold")
...
variant_df %>% 
  ...
  ggplot(.,aes(x=good_HLA,y=n_HLA_mutations,color=good_HLA))+
    ...
    ggtitle("(gag,pol,nef,vif) HLA-specific mutations vs ATI Duration",subtitle = "Adapted Mutations")+
    theme(
      plot.title = element_text(color="black", size=14, face="bold.italic"),
      axis.title.x = element_text(color="darkgrey", size=12, face="bold"),
      axis.title.y = element_text(color="darkgrey", size=12, face="bold")
...
Apparently there are no significant difference between placebo and vaccine groups regarding the number of HLA-specific mutations, including only adapted mutations.
